...
<body>
    ...
    <section>
        <nav>
            <ul>
                <li><a href="plyta_glowna.php">Płyta główna</a></li>
                <li><a href="karta_graficzna.php">Karta graficzna</a></li>
                <li><a href="procesor.php">Procesor</a></li>
                <li><a href="pamiec_ram.php">Pamięć RAM</a></li>
            </ul>
        </nav>
    </section> 
